                ...
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    ...
                    <div>
                        ...
                        <p className="text-white/50 mt-4 text-lg">
                            Layers seamlessly connects with your favourites
                    ...
                    {/* second */}
                    <div>
                        <div className=" mt-8 h-[400px] lg:h-[800px] lg:mt-0 overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,%,transparent)] grid md:grid-cols-2 gap-4 ">
